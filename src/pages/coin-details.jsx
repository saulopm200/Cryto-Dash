...
//const API_URL = import.meta.env.VITE_COIN
...
const CoinDetailsPage = () => {
    ...
    return  <div className="coin-details-container">
        ...
        {!loading && !error && (
            ...
            <img src={coin.image.large} alt={coin.name}
             className="coins-details-image"
              ...
              <div className="coin-details-info">
                ...
                <h3>Current Price : $ { coin.market_data_current_price.usd.toLocaleString()}</h3>
            ...
            <h4>Last Update: {new Date(coin.last_updated).toLocaleDateString() }</h4>
